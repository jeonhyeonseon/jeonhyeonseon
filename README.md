...
### 요구사항을 기능 단위로 정리하고, 기존 코드 흐름을 해치지 않으며 구현하는 백엔드 개발자입니다.

- 인증·게시판·실시간 채팅 등 서비스 필수 기능 직접 설계·구현
- 프론트엔드까지 직접 구현하며 전체 흐름을 고려한 개발 경험
- 이후 기능 추가 시 영향 범위를 줄이기 위한 구조 개선 및 리팩토링
